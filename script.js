...
itemSoloItaliano: '',
  ...
  it: {
    ...
    sobreMiParrafo1: 'Da diversi anni mi occupo di traduzioni con valore legale, in particolare per la cittadinanza italiana, atti, certificati, procure e altri documenti che richiedono <b>precisione</b> e <b>conoscenza del linguaggio giuridico.</b> Sono iscritta all’<a style="color: #222" href="https://traductoreslaplata.org/usuario/cdimarco/" target="_blank" rel="noopener noreferrer">Ordine dei Traduttori e degli Interpreti della Provincia di Buenos Aires - sede La Plata</a> e della <a style="color: #222" href="https://www.traductores.org.ar/traductor/dimarco-calello-carla-edith/" target="_blank" rel="noopener noreferrer">Città di Buenos Aires</a>.',
...
itemSoloItaliano: 'ogni tipo di documento legale.',
    ...
    contactoTitulo: "Dimmi Hola e partiamo",
    formNombreLabel: "Nome",
    formEmailLabel: "email",
    formMensajeLabel: "Messaggio",
    formEnviarBtn: "Invia",
    descubriTitulo: 'Chi sono <br>e <br>cosa faccio',
    contactoSubtitulo: 'Sono a tua disposizione per qualsiasi domanda sui miei servizi di traduzione',
